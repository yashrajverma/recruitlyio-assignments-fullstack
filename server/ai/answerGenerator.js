...
async function generateAnswers(
  ...
  const prompt = `Act as an expert AI Interview Answers Generator for a technical hiring process. Your task is to analyze the provided questions array, and generate detailed, professional answers based on the experience level ${experienceLevel} of the domain ${candidatePosition}. 
    The answers should demonstrate the candidate's expertise and practical experience in a concise manner.
    ...
    messages: [
      {
        role: "system",
        content:
          "You are an AI assistant that generates interview answers based on the candidate's skills, working position, and experience level. Provide responses in JSON format.",
      },
      {
        role: "user",
        content:
